...
# <img width="38" style="vertical-align:middle" alt="Telegram" src="media/icons/Telegram.png"> Результат выполнения автотестов в Телеграм
...
# <img width="38" style="vertical-align:middle" title="Selenoid" src="media/icons/Browserstack.svg"> Видео примера запуска теста в Browserstack
